...
keys = [
    ...
    Key(
        ...
        desc="Mutes Alsa Master volume",
    ),
    Key(
        [],
        "XF86AudioLowerVolume",
        lazy.spawn("amixer set Master 5%-"),
        desc="Lowers Alsa Master volume",
    ),
    Key(
        [],
        "XF86AudioRaiseVolume",
        lazy.spawn("amixer set Master 5%+"),
        desc="Raises Alsa Master volume",
    ),
    Key(
        [],
        "XF86MonBrightnessUp",
        lazy.spawn("pkexec /usr/bin/brillo -q -A 3"),
        desc="Raises backlight",
    ),
    Key(
        [],
        "XF86MonBrightnessDown",
        lazy.spawn("pkexec /usr/bin/brillo -q -U 3"),
        desc="Lowers backlight",
    ),
    Key([mod], "p", lazy.spawn(expanduser(lockScreen), shell=True), desc="Lock screen"),
